...
// import { FaBriefcase, FaCalendarAlt, FaInfoCircle, FaCheckCircle, FaTimesCircle } from "react-icons/fa";
...
//     // Add logic to handle applying to a specific job
//     console.log(`Applying to job with ID ${jobId}`);
//     Navigate('/JobApplyForm')
//   };
...
//                   <a
//                     className=" bg-gradient-to-r from-green-400 to-blue-500 text-white cursor-pointer  font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition duration-300"
